...
# Save to outputs
df_movies.to_csv('outputs/csv_files/netflix_movies_clean_2015.csv', index=False) # No index coulmn in data i.e no column giving every row a number
...
df_exploded.to_csv('outputs/csv_files/netflix_movies_exploded.csv', index=False)