...
conn = sqlite3.connect('./databases/netflix_project.db') # creates connection object
...
df_movies.to_csv('outputs/csv_files/netflix_movies_processed.csv',index=False)
